...
try {
    ...
    if ($verify->num_rows > 0) {
        ...
        echo "<p><a href='../profile.php' style='color:#00d2ff;'>→ Go to Profile Page</a></p>";
    }
...
echo "<hr>";
echo "<p style='color:#666;font-size:12px;'>You can safely delete this file after running it: admin/migrate-avatar.php</p>";
echo "</body></html>";
?>

...
// TODO: Get user's unlocked achievements from database
// For now, we'll show all achievements with mock unlock status
$unlockedAchievements = []; // Will be populated from database
    ...
    <main class="pt-24 pb-12 px-4 md:px-8 max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
            <div class="g-card p-6 text-center">
                <div class="text-4xl font-black text-green-400 mb-2">0</div>
            ...
            <div class="g-card p-6 text-center">
                <div class="text-4xl font-black text-orange-400 mb-2">-</div>
        ...
        <div class="mb-12">
            <div class="flex items-center justify-between mb-6">
                ...
                <span class="inline-flex items-center rounded-md bg-<?php echo $color; ?>-400/10 px-3 py-1.5 text-sm font-bold text-<?php echo $color; ?>-400 ring-1 ring-inset ring-<?php echo $color; ?>-400/20">
                    0 / <?php echo count($tierData['items']); ?>
                </span>
            </div>
            
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <?php foreach ($tierData['items'] as $achievement): 
                    $isLocked = true; // TODO: Check from database
                    $cardClass = $isLocked ? 'achievement-card achievement-locked' : 'achievement-card';
                ?>
                <div class="g-card p-6 <?php echo $cardClass; ?> border-l-4 border-l-<?php echo $color; ?>-500">
                    ...
                    <?php if (!$isLocked): ?>
                    <div class="mt-4">
                        <button class="w-full g-btn g-btn-blue py-2 text-xs">

    ...
    <nav class="g-nav fixed w-full z-50 px-6 py-4 flex justify-between items-center bg-[#0f172a]/95 backdrop-blur-md border-b border-white/5">
        <div class="flex items-center gap-8">
            ...
            <div class="hidden md:flex items-center gap-1">
                ...
                <a href="achievements.php" class="px-4 py-2 rounded-lg bg-white/5 text-white font-bold text-sm uppercase tracking-wide border border-white/10 transition-all shadow-[0_0_15px_rgba(255,255,255,0.1)]">
                    <i class="fas fa-medal mr-2 text-purple-500"></i> Achievements
                </a>
            </div>
        </div>
